        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                for (Asignatura asignatura : li_as) {
                    out.println("<li>");
                    out.println(asignatura.getCiclo()+ " " + asignatura.getCurso()+ " " + asignatura.getNombre());
                    out.println("<a href=\"ActualizarAlumno?id=" + asignatura.getId()
                            + "&nombre=" + asignatura.getNombre() + "&curso="
                            + asignatura.getCurso()+ "\">" + "&ciclo="
                            + asignatura.getCiclo() +"actualizar</a>");
                    out.println("<a href=\"BorrarAlumno?id=" + asignatura.getId() + "\">" + "borrar</a>");
                    out.println("</li>");
                }
                out.println("</ol>");
